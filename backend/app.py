...
from email_service import send_password_reset_email as resend_password_reset_email
...
def forgot_password():
    ...
    try:
        ...
        username = getattr(
            user,
            "username",
            "Ramon Marketplace User"
        )

        email_sent = resend_password_reset_email(
            user.email,
            username,
            reset_link
        )
        ...
        if email_sent:
            ...
            print(
                "WARNING: PASSWORD RESET EMAIL WAS NOT SENT"
            )
